<h1 style="text-align:center; margin:20px 0px;">Hasil Pencarian</h1>
<?php
    if(isset($_POST["cari"])){
       
        $keyword = $_POST["keyword"];
        $produk = mysqli_query($kon, "SELECT * FROM barang WHERE mBarang LIKE '%$keyword%' OR jBarang LIKE '%$keyword%'");
